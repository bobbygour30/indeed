...
export default function PasswordProtectedPage() {
  ...
  // ---- Make payment → remove QR & go to /jobs -------------------------
  const handleMakePayment = () => {
    // You can call any payment API here if needed
    navigate('/jobs');          // redirect using react-router-dom
  };
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-2 text-gray-600 text-sm">
                <span>Home</span>
                <span>•</span>
                <span className="text-gray-900 font-medium">Interview ID Service</span>
              </div>
            </div>
          </div>
        </nav>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-6">
        <div className="bg-white rounded-xl shadow-lg p-10 max-w-xl w-full text-center">
          ...
          <p className="text-xl font-mono break-all mt-1 mb-8">
            Amount: 5850
          </p>

          <div className="space-y-4">
            {/* Make Payment → removes QR & redirects */}
            <button
